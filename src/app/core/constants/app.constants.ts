...
/** URL de base Grafana (dashboard en temps réel). Modifier si Grafana est sur un autre host/port. */
export const GRAFANA_BASE_URL = 'http://localhost:3000';
/** UID du dashboard à afficher (ex. VIREMENT RECU). Vide = page d’accueil Grafana. Récupérer via Share > Link dans Grafana. */
export const GRAFANA_DASHBOARD_UID = '';
/** Rafraîchissement auto du dashboard (ex. 30s pour quasi temps réel). */
export const GRAFANA_REFRESH_INTERVAL = '30s';
